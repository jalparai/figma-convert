    ...
    <>
      <div>
        <div className="import_strip ">
          <div>
            <h2 className="title_tag">{t('pageTitle')}</h2>
          </div>
              ...
              <div className="col-lg-6">
                <div className="prod_img_sec">
                  ...
                  <input
                    ...
                    ref={fileInputRef}
                  />
                  <button onClick={openFileInput}>{t('changeImage')}
</button>
                </div>
                ...
                <div className="add_opt">
                  ...
                  <div>
                    <div>
                      <div className="add_pricing_inpt option_added_ui">
                        <div>
                          <label htmlFor="SPAN">İsim</label>
                          <div
                            className="add_option_radio "
                            style={{ width: "222px", paddingRight: "0px" }}
                          >
                        ...
                        <div>
                          <label htmlFor="SPAN">Required</label>
                          <div className="add_option_radio">
                            <input type="radio" name="" id="" />
                            <span>Event</span>
                          </div>
                        </div>
                        <div className="option_modal_btn">
                          <button className="delet_btn">
                            <svg
              ...
              <div className="price_added_link" key={index}>
                <div className="add_pricing_inpt">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPriceDetails("name", e.target.value, index)
                    }
                  />
                </div>
                ...
                <div className="add_pricing_inpt">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setPriceDetails("listingName", e.target.value, index)
                    }
                  >
                ...
                <div className="add_pricing_inpt">
                  ...
                  <div className="increaser_decreaser" key={index}>
                    ...
                    <button onClick={() => decreaseQuantity(index)} key={index}>
                      -
                    </button>
                  </div>
                </div>
                ...
                <div className="add_pricing_inpt">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPriceDetails("price", e.target.value, index)
                    }
                  />
                </div>
                ...
                <div className="add_pricing_inpt">
                  ...
                  <select
                    ...
                    id=""
                    onChange={(e) =>
                      setPriceDetails("currency", e.target.value, index)
                    }
                ...
                <div className="add_pricing_inpt">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPriceDetails("vat", e.target.value, index)
                    }
                  />
                </div>
